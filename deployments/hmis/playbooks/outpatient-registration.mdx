...
Register a walk-in or scheduled outpatient at the hospital front desk. This playbook combines the [register patient](/flows/clinical/register-patient) flow with HMIS-specific edge cases your registration team will hit in production.

## Flows involved

| Order | Flow | Purpose |
| --- | --- | --- |
| 1 | [Register a patient](/flows/clinical/register-patient) | New visitor with no existing record |
...
This matches the core [register patient](/flows/clinical/register-patient) flow without additional configuration.
...
- Flow: [Register a patient](/flows/clinical/register-patient)
