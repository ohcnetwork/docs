...
Enroll a patient into a community or facility-based palliative program. This playbook combines the [register patient](/flows/clinical/patient/register-patient) flow with palliative-specific intake, caregiver capture, and program assignment.

## Flows involved

| Order | Flow | Purpose |
| --- | --- | --- |
| 1 | [Register a patient](/flows/clinical/patient/register-patient) | New patient with no existing record |
