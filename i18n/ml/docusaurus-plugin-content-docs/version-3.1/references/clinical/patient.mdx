...
കെയർ EMR-ലെ `Patient` മൊഡ്യൂളിന്റെ സാങ്കേതിക റഫറൻസ്. ഉൽപ്പന്ന ഓവർവ്യൂക്കായി [രോഗി ആശയം](../../concepts/clinical/patient) കാണുക.
...
- ഫ്ലോ: [രോഗിയെ സൃഷ്ടിക്കുക](../../flows/clinical/patient/register-patient)
