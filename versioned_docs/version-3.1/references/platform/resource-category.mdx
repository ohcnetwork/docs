...
| Value | Meaning |
| --- | --- |
| `product_knowledge` | Category classifies [Product Knowledge](../definitions/product-knowledge.mdx) entries |
| `activity_definition` | Category classifies [Activity Definitions](../definitions/activity-definition.mdx) |
| `charge_item_definition` | Category classifies [Charge Item Definitions](../definitions/charge-item-definition.mdx); enables the monetary-component fields |
...
- Reference: [Activity Definition](../definitions/activity-definition.mdx)
