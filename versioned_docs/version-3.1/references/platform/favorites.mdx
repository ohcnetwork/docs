...
| --- | --- | --- |
| `activity_definition` | [Activity definition](../definitions/activity-definition.mdx) | `ActivityDefinitionViewSet` |
| `charge_item_definition` | [Charge item definition](../definitions/charge-item-definition.mdx) | `ChargeItemDefinitionViewSet` |
| `product_knowledge` | [Product knowledge](../definitions/product-knowledge.mdx) | `ProductKnowledgeViewSet` |
| `observation_definition` | [Observation definition](../definitions/observation-definition.mdx) | _(enum value defined; no viewset wires it yet)_ |
| `questionnaire` | [Questionnaire](../definitions/questionnaire.mdx) | `QuestionnaireViewSet` |
| `facility_organization` | [Organization](../access-governance/organization.mdx) (facility org) | `FacilityOrganizationViewSet` |
...
- [`User`](../access-governance/user.mdx) — owner of every favorites row (`user` FK)
...
- Favoritable resources: [Activity definition](../definitions/activity-definition.mdx), [Charge item definition](../definitions/charge-item-definition.mdx), [Product knowledge](../definitions/product-knowledge.mdx), [Observation definition](../definitions/observation-definition.mdx), [Questionnaire](../definitions/questionnaire.mdx), [Organization](../access-governance/organization.mdx)
