...
- [Activity Definition](../definitions/activity-definition.mdx) — template a request can be created from; supplies the `category` enum and `code` value set
- [Encounter](../clinical/encounter.mdx) — required context on create; supplies the patient
- [Patient](../clinical/patient) — subject, derived from the encounter
- [Specimen](../clinical/specimen.mdx) — specimens collected for a request
- [Diagnostic Report](../clinical/diagnostic-report.mdx) — reports produced for a request
- [Observation](../clinical/observation.mdx) — shares the body-site value set
...
- [User](../access-governance/user.mdx) — requester / audit users
