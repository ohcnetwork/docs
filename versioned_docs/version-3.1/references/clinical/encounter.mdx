...
- To set a facility identifier on an encounter, use the `encounter-set-facility-identifier` action (`POST /api/v1/encounter/{external_id}/set_facility_identifier/`).
