...
The facility offering the service. `PROTECT` blocks deleting a facility that still has healthcare services. Excluded from specs and set from the request context. See [Facility](./facility.mdx).
