...
- **Observation definition** — an [observation definition](../definitions/observation-definition.mdx) can act as the template, supplying expected codes, units, and reference ranges.
