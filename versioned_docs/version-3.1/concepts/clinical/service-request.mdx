...
Access to service requests is governed by two facility-scoped permissions.

| Permission | Description | System Roles |
| --- | --- | --- |
| Can Write Service Request on Facility | Create and update service requests within a facility | Facility Admin, Admin, Doctor, Nurse |
| Can Read Service Request | View service requests within a facility | Facility Admin, Administrator, Admin, Staff, Doctor, Nurse, Volunteer, Pharmacist |
