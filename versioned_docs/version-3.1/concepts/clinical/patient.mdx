...
Note: Only a system administrator can permanently delete a patient record. Regular staff
roles cannot delete a patient record.

{/*
## Configuration

Note: The fields that are mandatory at registration depend on your deployment's
...
- Flow: [Register a patient](../../flows/clinical/patient/register-patient.mdx)
- Flow: [View a patient's profile](../../flows/clinical/patient/view-patient-profile.mdx)
- Flow: [Update patient details](../../flows/clinical/patient/update-patient-details.mdx)
- Flow: [Manage patient identifiers](../../flows/clinical/patient/manage-patient-identifiers.mdx)
- Flow: [Manage patient tags](../../flows/clinical/patient/manage-patient-tags.mdx)
- Flow: [Mark a patient as deceased](../../flows/clinical/patient/mark-patient-deceased.mdx)
- Flow: [Manage patient users](../../flows/clinical/patient/manage-patient-users.mdx)
- Flow: [View a patient's appointments and tokens](../../flows/clinical/patient/view-patient-appointments.mdx)
