...
This is why you create a [Service Request](../clinical/service-request.mdx) before a report can be filed against it, and why deleting the patient, encounter, or originating request also removes the reports tied to them.
