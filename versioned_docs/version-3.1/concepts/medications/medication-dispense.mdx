...
| Medication Dispense Read | View medication dispenses | Facility Admin, Admin, Staff, Doctor, Nurse, Pharmacist |
| Write Medication Dispense | Create and update medication dispenses | Facility Admin, Admin, Staff, Doctor, Nurse, Pharmacist |
