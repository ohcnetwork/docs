...
- **Value sets** back every coded field (code, unit, body site, method). The submitted code is checked against the bound [value set](../../references/definitions/valueset.mdx), which is what keeps the data translatable to FHIR.
...
- Reference: [Observation Definition (technical)](../../references/definitions/observation-definition.mdx)
- Concept: [Observation](../clinical/observation.mdx)
- Concept: [Service Request](../clinical/service-request.mdx)
- Reference: [Questionnaire](../../references/definitions/questionnaire.mdx)
- Reference: [Value Set](../../references/definitions/valueset.mdx)
