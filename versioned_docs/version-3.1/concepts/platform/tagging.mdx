...
| --- | --- | --- |
| Can Create Tag Config on Facility | Define new tags and edit their definitions within a facility | Facility Admin, Admin |
| Can Apply Tag Config to Resources | Attach existing tags to patients, encounters, and other records | Facility Admin, Admin, Staff, Doctor, Nurse, Pharmacist |
| Can Read Tag Config | View tag definitions and the tags applied to records | Facility Admin, Administrator, Admin, Staff, Doctor, Nurse, Volunteer, Pharmacist |
