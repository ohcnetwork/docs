...
- **[Charge item definitions](../../references/billing/charge-item-definition.mdx)** — the priced catalogue entries charge items are built from, used when Care generates a refund invoice automatically.
...
| --- | --- | --- |
| Can Write Invoice | Create and update invoices, including assembling charge items and issuing them | Facility Admin, Admin, Staff, Doctor, Nurse, Pharmacist |
| Can Read Invoice | View invoices, their line items, totals, and reconciliation history | Facility Admin, Administrator, Admin, Staff, Doctor, Nurse, Volunteer, Pharmacist |
| Can Destroy Invoice | Delete an invoice | Facility Admin, Admin |
| Can Manage Locked Invoice | Lock and unlock invoices to freeze or reopen them | Facility Admin, Admin |
