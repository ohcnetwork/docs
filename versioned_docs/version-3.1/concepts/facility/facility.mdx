...
- **Geography** — each facility sits under a geographic [organization](./organization.mdx), the bridge that connects it to the wider administrative map
...
| --- | --- | --- |
| Can Create on Facility | Create a new facility | Administrator, Admin, Facility Admin |
| Can Read on Facility | View a facility's details | Facility Admin, Administrator, Admin, Staff, Doctor, Nurse, Volunteer |
