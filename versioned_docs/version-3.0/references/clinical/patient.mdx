...
Technical reference for the `Patient` module in Care EMR. For a product-oriented overview, see the [Patient concept](../../concepts/clinical/patient).
...
| Field definitions | `Patient` fields |
