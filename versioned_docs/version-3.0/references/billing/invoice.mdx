...
| `number` | `CharField(1000)` | `str \| None`, default `None` | Auto-generated for return invoices via the facility's `invoice_number_expression` (see [Methods](#methods--save-behaviour)) |
