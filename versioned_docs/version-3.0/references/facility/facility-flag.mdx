...
| --- | --- | --- |
| `USER` | `"USER"` | `UserFlag` ([User](../access-governance/user.mdx)) |
...
- Reference: [User](../access-governance/user.mdx) — the `USER` flag counterpart of the same `BaseFlag` machinery
