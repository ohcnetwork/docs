...
A `HealthcareService` describes a service offered at a facility (e.g. cardiology, lab, radiology, pharmacy), scoped to one or more locations and a managing facility organization.
...
| Field definitions | `HealthcareService` fields |
| Allowed values | Enums |
| Structured payloads | Coded field shapes (JSON fields) |
