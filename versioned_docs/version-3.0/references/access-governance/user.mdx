...
- Reference: [Role](../access-governance/role.mdx), [Permission](../access-governance/permission.mdx), [Permission association](../access-governance/permission-association.mdx)
- Reference: [Organization](../access-governance/organization.mdx), [Facility](../facility/facility.mdx)
