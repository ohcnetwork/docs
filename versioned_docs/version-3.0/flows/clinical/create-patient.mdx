...
:::info Prerequisite
Read [Patient](../../concepts/clinical/patient.mdx) to understand what a patient record contains and how identifiers work.
:::
...
- Reference: [Patient (technical)](../../references/clinical/patient.mdx)
