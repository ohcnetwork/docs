...
| --- | --- | --- |
| Can Create Supply Delivery on Facility | Record a delivery and add its lines within the facility | Facility Admin, Admin |
| Can Read Supply Delivery | View deliveries and their delivery orders | Facility Admin, Administrator, Admin, Staff, Doctor, Nurse, Volunteer, Pharmacist |
| Can Create External Supply Delivery on Facility | Record a delivery of stock arriving from an outside supplier | Facility Admin, Admin |
