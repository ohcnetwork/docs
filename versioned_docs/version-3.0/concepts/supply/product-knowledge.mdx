...
Product Knowledge is not the same as a [Product](./product.mdx) or an [Inventory Item](./inventory-item.mdx). Knowledge is the abstract definition (what "Paracetamol 500 mg tablet" *is*); a Product is a concrete stockable form of it; an Inventory Item is the physical quantity sitting in a particular location. One Knowledge entry underpins many Products and countless Inventory Items — define it once, reuse it everywhere.
...
- **Product** — every [Product](./product.mdx) references exactly one Product Knowledge entry for its definition
- **Inventory Item** — physical [Inventory Items](./inventory-item.mdx) trace back through their Product to this definition
...
| --- | --- | --- |
| Can Create Product Knowledge on Facility | Create and edit product definitions for a facility | Facility Admin, Admin |
| Can Read Product Knowledge | View the product catalogue and its definitions | Facility Admin, Administrator, Admin, Staff, Doctor, Nurse, Volunteer, Pharmacist |
...
- Reference: [Product Knowledge (technical)](../../references/supply/product-knowledge.mdx)
