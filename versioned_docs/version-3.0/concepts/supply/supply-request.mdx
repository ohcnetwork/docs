...
| --- | --- | --- |
| Can Create Supply Request on Facility | Create and update supply requests within a facility | Facility Admin, Admin, Staff, Doctor, Nurse |
| Can Read Supply Request | View supply requests within a facility | Facility Admin, Administrator, Admin, Staff, Doctor, Nurse, Volunteer, Pharmacist |
