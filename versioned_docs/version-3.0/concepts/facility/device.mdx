...
| --- | --- | --- |
| Can List Devices on Facility | View the devices registered to a facility | Staff, Admin, Doctor, Nurse, Facility Admin, Pharmacist |
| Can Manage Devices on Facility | Create, update, place, and service devices | Staff, Admin, Facility Admin, Pharmacist |
| Can Manage Device Associations to Encounters | Attach and detach devices from patient encounters | Staff, Admin, Doctor, Nurse, Facility Admin |
