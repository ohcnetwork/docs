...
| --- | --- | --- |
| Pharmacist in Care | Pharmacists have access to all medication requests and can create dispenses for patients | Facility Admin, Admin, Pharmacist |
| Update Encounter and Create all associated datapoints | Author, update, or discontinue a medication request on an encounter | Admin, Doctor, Nurse, Staff, Facility Admin |
| Can view clinical data about patients | View the medication requests recorded for a patient | Admin, Doctor, Nurse, Staff, Facility Admin |
| Can Read encounter and related data | View the medication requests on a specific encounter | Admin, Doctor, Nurse, Staff, Facility Admin |
