...
Access to diagnostic reports is governed by two facility-scoped permissions.

| Permission | Description | System Roles |
| --- | --- | --- |
| Can Create Diagnostic Report on Facility | Create and update diagnostic reports within a facility | Facility Admin, Admin, Doctor, Nurse |
