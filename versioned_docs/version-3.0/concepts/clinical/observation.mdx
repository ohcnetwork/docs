...
| --- | --- | --- |
| `can_view_clinical_data` | View clinical data about a patient, including their observations | Staff, Doctor, Nurse, Admin, Facility Admin |
| `can_read_encounter_clinical_data` | Read clinical data recorded within a specific encounter; used as the encounter-scoped fallback when reading observations | Admin, Doctor, Nurse, Facility Admin |
