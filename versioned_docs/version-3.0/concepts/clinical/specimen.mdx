...
| --- | --- | --- |
| Can Create Specimen on Facility | Create and update specimens within a facility — record collection, processing, and status changes | Facility Admin, Admin, Doctor, Nurse |
...
- Concept: [Service Request](./service-request.mdx) — the order a specimen fulfils
- Concept: [Specimen Definition](./specimen-definition.mdx) — the template a specimen can be derived from
- Concept: [Diagnostic Report](./diagnostic-report.mdx) — where a specimen's results surface
