...
| --- | --- | --- |
| Can Create Specimen Definition on Facility | Create and update specimen definitions in a facility's catalogue | Facility Admin, Admin |
| Can Read Specimen Definition | View specimen definitions when ordering, collecting, or reviewing samples | Facility Admin, Administrator, Admin, Staff, Doctor, Nurse, Volunteer, Pharmacist |
