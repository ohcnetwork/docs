...
- Concept: [Encounter](./encounter.mdx) — the context every request is raised in
- Concept: [Activity Definition](./activity-definition.mdx) — the template a request can be built from
- Concept: [Specimen](./specimen.mdx) — collected to fulfil a request
- Concept: [Diagnostic Report](./diagnostic-report.mdx) — the result produced for a request
