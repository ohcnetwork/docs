...
For an overview of all supported cloud providers and their infrastructure requirements, see the [Cloud providers overview](./index.md).
...
- Choose the following:
  ...
  ![Navigate to Databases](/img/devops/Deploy/Care/digitalOcean/do-db-1.png)

  - **Name**: Give your database a unique name.
  - **Tags**: Add tags for organization.

  ![Navigate to Databases](/img/devops/Deploy/Care/digitalOcean/do-db-2.png)

  ![Create Database](/img/devops/Deploy/Care/digitalOcean/do-db-3.png)

### 1.3 Save Connection Details

- Once the database is created, note the connection URL for later use.

  ![Connection String](/img/devops/Deploy/Care/digitalOcean/do-db-4.png)
...
- Click **Create a Space**.
  ...
  ![Create Space](/img/devops/Deploy/Care/digitalOcean/do-spaces-1.png)
...
- Choose:
  ...
  ![Create Space](/img/devops/Deploy/Care/digitalOcean/do-spaces-3.png)
...
- Create a new key pair and save the **Key** and **Secret**.
  ...
  ![Generate Keys](/img/devops/Deploy/Care/digitalOcean/do-spaces-2.png)
...
- Go to the App Platform and click **Create App**.
  ...
  ![Select App Platform](/img/devops/Deploy/Care/digitalOcean/do-app-1.png)
...
- Name the component `redis`.
  ...
  ![Select App Platform](/img/devops/Deploy/Care/digitalOcean/redis-1.png)

  ![Edit these fields](/img/devops/Deploy/Care/digitalOcean/redis-2.png)

#### 3.1.2 Name and Deploy

- Name the App `care-backend` and deploy it.

  ![Name and Deploy](/img/devops/Deploy/Care/digitalOcean/redis-3.png)
...
- Set the build and run commands:
  ...
  ![Create Resource from Source Code](/img/devops/Deploy/Care/digitalOcean/care-django-1.png)

  ![Select GitHub Repository](/img/devops/Deploy/Care/digitalOcean/care-django-2.png)
  ...
  - **Run Command:**
    ...
    ![Select GitHub Repository](/img/devops/Deploy/Care/digitalOcean/care-django-3.png)
...
The `JWKS_BASE64` value is generated here. Use the generator below to create a key, then paste the output into the `JWKS_BASE64` environment variable above.
...
- Update your DNS provider with the CNAME record.
  ...
  ![Add Domain](/img/devops/Deploy/Care/digitalOcean/domain.png)
...
- Use the following **Run Command**:
  ...
  ![Celery Worker](/img/devops/Deploy/Care/digitalOcean/worker-1.png)

  ![Celery Worker](/img/devops/Deploy/Care/digitalOcean/worker-2.png)
...
- Create another component with the following **Run Command**:
  ...
  ![Celery Job](/img/devops/Deploy/Care/digitalOcean/job-1.png)

  ![Celery Job](/img/devops/Deploy/Care/digitalOcean/job-2.png)
...
- Go to the app settings and add the frontend domain (e.g., `care.example.com`).
  ...
  ![Frontend Setup](/img/devops/Deploy/Care/digitalOcean/care-fe-1.png)

  ![Celery Job](/img/devops/Deploy/Care/digitalOcean/care-fe-2.png)

  ![Celery Job](/img/devops/Deploy/Care/digitalOcean/care-fe-3.png)
...
- Add the Care backend app as a trusted source.
  ...
  ![Secure Database](/img/devops/Deploy/Care/digitalOcean/secure-db.png)
...
- Add the following CORS configuration:
  ...
  ![CORS](/img/devops/Deploy/Care/digitalOcean/cors.png)
...
- **Optimize Security:**
  ...
  - Configure firewall rules to restrict access.
    ...
    ![Care Infra](/img/devops/Deploy/Care/digitalOcean/care-infra-do.png)
