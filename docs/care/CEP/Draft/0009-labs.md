...
##### 2.2 **Sample Collection and Association**
...
#### 3. **Workflow and Stages**

##### 3.1 **Lab Order Workflow**
...
##### 3.2 **Sample Stages (Modification of Existing Stages)**
...
##### 4.2 **Sample and Investigation Views**
...
##### 5.1 **Sample Types and Investigations**
...
##### 5.2 **Customizable Reference Ranges**
...
### 7 **Extensibility: Integration with External LIMS**

##### 7.1 **Initial Flow: Manual Management Inside CARE**
...
##### 7.2 **Plugin for External LIMS Integration**
...
##### 7.3 **Advantages of the Plugin-Based Approach**
