...
In this guide, we’ll walk you through deploying **Care** on **DigitalOcean**. We’ll keep things simple so you can follow along to get your instance up and running. Expect the process to take about **an hour**, depending on your familiarity with the tools.
...
- Set up the **Care frontend** for user access.
...
- Choose:
  ...
  - **Create**: Click to create the space.
...
- Expose port `9000` for public HTTP access.

---

### Step 3.3: Add a Domain for the Backend

#### 3.3.1 Configure Domain
...
- Create another component with the following **Run Command**:
...
### 4.1 Fork the Frontend Repository
...
- Go to the app settings and add the frontend domain (e.g., `care.example.com`).
...
For troubleshooting, feel free to join our Community on Slack at [slack.ohc.network](https://slack.ohc.network). You may also refer to the official [DigitalOcean Documentation](https://www.digitalocean.com/docs) for any questions about DigitalOcean.
